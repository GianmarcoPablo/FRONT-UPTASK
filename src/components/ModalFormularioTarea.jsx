...
const ModalFormularioTarea = () => {
    ...
    useEffect(() => {
        //tengo el problema de que cuando le doy a crear tarea, se quedan los datos de la tarea ala cual le di editar
        // como solucionar?
        if (tarea?._id) {
            setDatos({
                id: tarea._id,
    ...
    const handleSubmit = async e => {
        ...
        await submitTarea({ ...datos, proyecto: id })
        setDatos({
            id: "",
            nombre: "",
            descripcion: "",
                                    ...
                                    <form onSubmit={handleSubmit} className='my-10'>
                                        ...
                                        <div className='mb-5'>
                                            ...
                                            <textarea
                                                ...
                                                name='descripcion'
                                                className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md h-32 resize-none'
